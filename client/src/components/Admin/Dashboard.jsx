import { BellIcon, CalendarIcon, CurrencyDollarIcon, HeartIcon, ShoppingCartIcon, UserIcon } from '@heroicons/react/24/outline'
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              {[
                { name: 'John Doe', date: '2023-08-15', service: 'Nutrition Planning', status: 'upcoming' },
                { name: 'Jane Smith', date: '2023-08-14', service: 'Diet Review', status: 'completed' },
